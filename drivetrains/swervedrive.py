...
from drivetrains import swervemodule # Normally drivetrain would be replaced with components here
import math

#NOTE: To understand how the swervedrive system works, you must understand how the module works
# Please refer to the swervemodule.py code for further understanding
